...
router.post('/create-product',verifyToken, ApplyUseCase(mainProducts.create))//testado
...
router.delete('/delete',verifyToken, ApplyUseCase(mainProducts.delete))//testado
